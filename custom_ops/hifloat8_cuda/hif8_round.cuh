// HiFloat8 rounding function - header file for inline device function
// This needs to be inline to avoid linker errors with CUDA

#ifndef HIF8_ROUND_CUH
#define HIF8_ROUND_CUH

#include <cuda.h>
#include <cuda_runtime.h>

// HiFloat8 rounding: rounds to nearest HiFloat8-representable value
__device__ __forceinline__ float hif8_round_float(float x) {
